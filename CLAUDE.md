...
- 🟨 **Fase C — Motor de configuración + BOM + esquema visual**: ciclos 1 (backend del motor: modelo de datos, reglas de cálculo, API REST) y 2 (UI mínima: proyectos/tableros/secciones/salidas, esquema visual simple, edición post-creación de nivel de falla e interruptor principal, formato tripolar, validación de amperios enteros) mergeados a `master`. Specs: `docs/superpowers/specs/2026-07-16-fase-c-motor-configuracion-design.md`, `docs/superpowers/specs/2026-07-16-fase-c-ui-configurador-design.md`. Ciclo 3 (poblar `atributos` desde el Excel real de ABB) tiene spec (`docs/superpowers/specs/2026-07-16-catalogo-abb-atributos-design.md`) pero todavía no plan de implementación — es el siguiente paso antes de retomar mejoras de UI del configurador. Falta después: BOM y esquema visual más elaborado.
