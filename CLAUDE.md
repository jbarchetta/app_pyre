...
- 🟨 **Fase C — Motor de configuración + BOM + esquema visual**: ciclos 1 (backend del motor: modelo de datos, reglas de cálculo, API REST), 2 (UI mínima: proyectos/tableros/secciones/salidas, esquema visual simple, edición post-creación de nivel de falla e interruptor principal, formato tripolar, validación de amperios enteros) y 3 (poblar `atributos` del catálogo ABB real por regex sobre `categoria_path`/`descripcion` — ~69% de cobertura en categorías en-alcance, ver `docs/consultas_ingenieria.md` #1 para el resto) mergeados a `master`. Specs: `docs/superpowers/specs/2026-07-16-fase-c-motor-configuracion-design.md`, `docs/superpowers/specs/2026-07-16-fase-c-ui-configurador-design.md`, `docs/superpowers/specs/2026-07-16-catalogo-abb-atributos-design.md`. Falta: retomar UI del configurador (pausada a pedido del usuario), BOM, esquema visual más elaborado.
