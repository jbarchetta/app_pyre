    ...
    >
      ...
      >
        ...
        {hoveredSalidaInfo ? (
          ...
          <div
            className={`absolute bottom-6 left-1/2 -translate-x-1/2 z-40 rounded-md px-4 py-1 text-[11px] font-mono text-center select-none pointer-events-none transition-colors ${
              theme === "light"
