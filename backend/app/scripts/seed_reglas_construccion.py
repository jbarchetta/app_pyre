...
def seed_construccion_data():
    ...
    try:
        ...
        nis_cabinets = [
            ...
            ("NIS 300.600.XX", 300, 600, 3, 10, 30, 3, 10, 30, Decimal("82.00")),
            ("NIS 450.600.XX", 450, 600, 3, 16, 48, 3, 16, 48, Decimal("84.00")),
            ("NIS 600.600.XX", 600, 600, 3, 24, 72, 3, 24, 72, Decimal("128.00")),
